...
mongoose.connect(
  `mongodb+srv://${process.env.MONGODB_USERNAME}:${process.env.MONGODB_PASSWORD}@cluster0.nutzu67.mongodb.net/${process.env.MONGODB_DATABASE}?retryWrites=true&w=majority`
);
